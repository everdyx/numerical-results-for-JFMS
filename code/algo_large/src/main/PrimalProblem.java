...
//	private int preNumLogiTask;
	...
	public PrimalProblem(Instance para) {
		this.para = para;
		this.collaboration = true;
	}

	public PrimalProblem(Instance para2, int[] prodSeq2) {
	...
	public PrimalProblem(Instance para2, int p, double benchTss0,double benchTau) {
		// TODO Auto-generated constructor stub
		this.para = para2;
		this.collaboration = false;
		this.pindex = p;
