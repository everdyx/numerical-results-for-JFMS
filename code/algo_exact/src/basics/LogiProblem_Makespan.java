...
public class LogiProblem_Makespan {
...
//	ArrayList<ArrayList<Integer>> sequences = new ArrayList<>();
	...
	public LogiProblem_Makespan(Instance para) {
		this.para = para;
	}
	...
	public void buildModel() throws IloException {
		try {
			...
			// 定义变量类型、范围、名称
			makespan = model.numVar(0, Float.MAX_VALUE, IloNumVarType.Float, "makespan");
