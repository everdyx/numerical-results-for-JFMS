...
public class SubgradMethod_pure {
...
//	HashMap<String, ArrayList<ArrayList<Integer>> > mapHeurProdSeq_LogiSeq=new HashMap<String, ArrayList<ArrayList<Integer>> >();
    ...
    public SubgradMethod_pure(Instance para, double stepsizeFactor, boolean newLB) {
        this.para = para;
...
//        }
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException, IloException {
        ...
        Instance para = new Instance(2,2, 2, 2, false, 1, 0.5, 3,
                "data\\demand2.txt");
        para.Initialization(1);
        SubgradMethod_pure sgd = new SubgradMethod_pure(para, 1, false);
        sgd.initialization();
//        int[] b={1,0};
