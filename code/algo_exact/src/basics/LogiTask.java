...
public class LogiTask implements Serializable{
	...
	private double[] randLambda; //对应的是拉格朗日乘子
    ...
    public String toString() {
        return "[n: "+this.sample_id+", id" + this.id  + ": for Product " + this.correspProd.getId() 
	...
	public void setSampleId(int sample_id) {this.sample_id=sample_id;}
...
//	public double getRandLambda(int n) {
//		return randLambda[n];
//	}
...
//	public void setRandLambda(double[] lambda) {
//		this.randLambda = lambda;
//	}
